<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditPage.aspx.cs" Inherits="R161CMS.Admin.Content.EditPage" ValidateRequest="false" MasterPageFile="../Templates/MasterPages/Base.Master" %>
<%@ Import Namespace="R161CMS" %>
...
<asp:Content ContentPlaceHolderID="AdditionalScripts" runat="server">
    <script src="assets/js/R161cms.admin.editor.min.js?v=<%=Utils.VersionHash %>" type="text/javascript"></script>
