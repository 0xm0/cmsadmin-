<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CollectionPropertyEditor.ascx.cs" Inherits="R161CMS.Admin.Content.PropertyType.CollectionPropertyEditor" %>
