...
namespace R161CMS.Admin.Content.PropertyType {
    ...
    public partial class TagPropertyEditor : PropertyEditorBase {
        ...
        protected override void OnLoad(EventArgs e) {
            ...
            ScriptManager.RegisterClientScriptInclude(this, typeof(TagPropertyEditor), "assets/js/R161cms.admin.taginput.min.js", SiteSettings.Instance.AdminPath + "assets/js/R161cms.admin.taginput.min.js?v=" + Utils.VersionHash);
        }
