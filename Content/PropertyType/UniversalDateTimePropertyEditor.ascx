<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UniversalDateTimePropertyEditor.ascx.cs" Inherits="R161CMS.Admin.Content.PropertyType.UniversalDateTimePropertyEditor" %>
        ...
        $(function() {
            ...
            element.on('changeDate', function(e) {
                ...
                if (e.date != null && !isNaN(e.date.getTime())) {
                    newDate = moment.utc(e.localDate).format('<%=R161CMS.Configuration.SiteSettings.Instance.DateFormat.Replace("yyyy", "YYYY").Replace("dd", "DD")%>');
                }
