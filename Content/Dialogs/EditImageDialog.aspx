<%@ Page Title="Edit image" Language="C#" MasterPageFile="Dialog.Master" AutoEventWireup="true" CodeBehind="EditImageDialog.aspx.cs" Inherits="R161CMS.Admin.Content.Dialogs.EditImageDialog" %>

<%@ Register TagPrefix="cms" Namespace="R161CMS.Admin.WebControls" Assembly="R161CMS.Admin" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ScriptArea" runat="server">
  ...
  <script src="assets/js/R161cms.admin.imageeditor.min.js"></script>
  <script>
    (function (iife) {
      iife(jQuery, window);
    }(function ($, window) {
