<%@ Page Title="Select file" Language="C#" MasterPageFile="Dialog.Master" AutoEventWireup="true" CodeBehind="SelectFileDialog.aspx.cs" Inherits="R161CMS.Admin.Content.Dialogs.SelectFileDialog" %>
<%@ Import Namespace="R161CMS.Configuration" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptArea" runat="server">
  <script src="assets/js/R161cms.admin.fileupload.min.js" type="text/javascript"></script>
